...
const RoomDetails = () => {
    ...
    const roomDetail=useSelector(state=>state.overnightRoomInfo);
    ...
    const handleClickSave = (room,price) => {
        ...
        if (existingRoomIndex !== -1) {
            const updatedRooms = selectedRooms.map((selectedRoom, index) => index === existingRoomIndex ? 
            { ...selectedRoom, quantity , price} : selectedRoom);
                 ...
                 const groupedRooms = res.data.reduce((acc, room) => {
                    ...
                    if (existingGroup) {
                        existingGroup.details.push({
                         ...
                         id: room._id,adult:room.adults,children:room.children,
                         infant:room.infant,toodler:room.toddler });
                    }
                    else {
                ...
                <div className='w-[100%] lg:w-[70%]  gap-x-3'>
                    ...
                    <div className='mt-6 lg:mt-10 w-[100%] flex justify-start items-center pl-0 lg:pl-[5%]'>
                        ...
                        <div className=''>
                            ...
                            {/* EXTRAS  */}
                            <div>
                                <Extras setFinalData={setFinalData} finalData={finalData} type={"overnight"} />
                            </div>
