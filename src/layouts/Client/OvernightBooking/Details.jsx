        ...
        <div>
                        ...
                        <div className='w-[100%] lg:w-[90%]'>
                            ...
                            <div className='w-[100%] lg:w-[90%]'>
                                ...
                                <div className='mt-4 block lg:flex justify-between items-center gap-x-4 lg:w-[83%] w-[100%]'>
                                    ...
                                    type="text" placeholder='First name' className='flex-1 h-[2.4rem] w-[100%] rounded-md bg-white pl-3 pr-3 outline-none border-2 border-[#C8D5E0]' />
            ...
            <div className='w-screen bg-white'>
                ...
                <div className='flex justify-between items-center px-7 pt-4'>
                    ...
                    <div className='flex gap-x-1 items-center text-[#75A9BF] cursor-pointer' onClick={() => nav("/overnight/room-details")}>
                        <MdKeyboardArrowLeft />
                        <p>Back</p>
                    </div>
                    <div>
